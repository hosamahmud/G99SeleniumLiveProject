package verifytheinvalidusernameTestCase2;
...
public class VerifyInvalidUsernameTestCase2Helper extends VerifyInvalidUsernameTestCase2Po {

    public <WebDriver> VerifyInvalidUsernameTestCase2Helper(WebDriver driver) {
